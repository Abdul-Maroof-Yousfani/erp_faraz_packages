...
@section('content')
                ...
                <div class="dp_sdw">    
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">Create Receipt Voucher</span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            ...
                            <select onchange="getRecieptDataClientWise()" name="ClientId" id="ClientId" class="form-control select2">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-left">
                            <input type="button" value="View Filter Data" class="btn btn-sm btn-primary" onclick="getRecieptDataClientWise()" style="margin-top: 32px;" />
                        </div>
                    </div>
    ...
    <script>
        ...
        function getRecieptDataClientWise()
        {
            ...
            $.ajax({
                url: '{{ url('/sdc/getRecieptDataClientWise') }}',
                type: 'Get',
