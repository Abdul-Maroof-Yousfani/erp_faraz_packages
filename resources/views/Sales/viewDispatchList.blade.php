                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="headquid ">
                                    <span class="subHeadingLabelClass">View Dispatch List</span>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <th class="text-center col-sm-1">Production Plan No</th>
                                            <th class="text-center col-sm-1">DC  List</th>
                                            <th class="text-center col-sm-1">Packing List</th>

                                            <th class="text-center col-sm-1">Dispatch No</th> 
                                            <th class="text-center col-sm-1">Dispatch Date</th> 
                                            ...
                                            @foreach ($dispatch as $row)
                                                <tr>
                                                    ...
                                                    <td>{{$row->order_no}}</td>
                                                    <td>{{$row->dc_no  }}</td>
                                                    <td>{{$row->packing_list_no  }}</td>
                                                    <td>{{$row->dispatch_no  }}</td>
                                                    <td>{{$row->dispatch_date  }}</td>
                                                    <td>{{$row->sub_ic?? '---'  }}</td>
                                                    <td>{{CommonHelper::byers_name($row->customer_id)->name??'---' }}</td>
                                                    <td>{{$row->dispatch_status == 1 ? 'pending' : 'approve'  }}</td>
                                                    <td>
                                                        <button onclick="showDetailModelOneParamerter('sales/viewDispatchDetail/<?php echo $row->id ?>','','View Dispatch')"
    ...
    <script>
        ...
        function delivery_note_delete(id,m)
        {
            if (confirm('Are you sure you want to delete this request')) {
                ...
                $.ajax({
                    url: base_url+'/sad/dispatch_delete',
                    type: 'GET',
                    data: {id: id, m:m},
        ...
        {
            var base_url='<?php echo URL::to('/'); ?>';
            window.location.href = base_url+'/sales/EditDispatch?id='+id+'&&'+'m='+m;
        }
