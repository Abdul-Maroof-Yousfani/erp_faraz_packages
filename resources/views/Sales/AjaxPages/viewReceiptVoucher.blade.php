                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                ...
                                <?php $breakup = DB::Connection('mysql2')->table('brige_table_sales_receipt as a')
                                        ...
                                        ->select('a.*','c.gi_no','c.so_type','c.description','c.so_no','c.sales_tax','c.sales_tax_further','c.advance_tax_amount','c.cartage_amount');
                                       ...
                                       ?>
                                        ...
                                        <?php $freight = SalesHelper::get_freight($row3->si_id); ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    {{number_format(SalesHelper::get_total_amount_for_sales_tax_invoice_by_id($row3->si_id)->amount + $row3->sales_tax + $row3->sales_tax_further + $freight + $row3->advance_tax_amount + $row3->cartage_amount,2)}}
                                                </td>
                                            ...
                                            <?php
                                                ...
                                                $invoice_amount += SalesHelper::get_total_amount_for_sales_tax_invoice_by_id($row3->si_id)->amount + $row3->sales_tax + $freight + $row3->sales_tax_further + $row3->advance_tax_amount + $row3->cartage_amount;
