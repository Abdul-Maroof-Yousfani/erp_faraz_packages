                            ...
                            <div class="table-responsive">
                                <table style="border:1px solid black;"  class="table  sales_Tax_Invoice_data">
                                    ...
                                    <tr class="text-center" style="font-weight: bold">
                                        ...
                                        <td class="text-right" colspan="1" style="border:1px solid black;"> {{ number_format($total_after_tax+$total_expense,2) }} </td>
                                    </tr>

                                    <tr class="text-center" style="font-weight: bold">
                                        <td colspan="13" style="border:1px solid black;">Advance Tax</td>
                                        <td class="text-right" colspan="1" style="border:1px solid black;"> {{ number_format($sales_tax_invoice->advance_tax_amount,2) }} </td>
                                    </tr>
                                    <tr class="text-center" style="font-weight: bold">
                                        <td colspan="13" style="border:1px solid black;">Cartage Amount</td>
                                        <td class="text-right" colspan="1" style="border:1px solid black;"> {{ number_format($sales_tax_invoice->cartage_amount,2) }} </td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr class="text-center" style="font-weight: bold">
                                        <td colspan="13" style="border:1px solid black;">Grand Total</td>
                                        <td class="text-right" colspan="1" style="border:1px solid black;"> {{ number_format($total_after_tax + $total_expense + $sales_tax_invoice->cartage_amount + $sales_tax_invoice->advance_tax_amount,2) }} </td>
                                    </tr>
...
//                $("#printable").css("display", "none");
        ...
        $(document).ready(function(){
            toWords(1);
            //printViewThis('printPurchaseRequestVoucherDetail','',1);
        });
        
        function printViewThis(param1,param2,param3)
        {
            $('header').css('display','none');
            $('.directHide').css('display','none');
