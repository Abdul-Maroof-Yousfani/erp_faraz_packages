...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">Create Dispatch</span>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <th class="text-center col-sm-1">DC No</th>                                          
                                            <th class="text-center col-sm-1">Packing List No</th>                                          
                                            <th class="text-center col-sm-1">No of Bundles</th>                                          
    ...
    <script>
        ...
        function viewRangeWiseDataFilter()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/sdc/getSalesOrderDateWiseForDispatch',
                type: 'Get',
        ...
        function dispatch(id,m , so_id)
        {
            var base_url='<?php echo URL::to('/'); ?>';
            window.location.href = base_url+'/sales/CreateDispatch?id='+id+'&p_id='+so_id+'&'+'m='+m;
        }
    </script>
