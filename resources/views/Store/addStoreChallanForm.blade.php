                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="headquid">
                                    ...
                                    <h2 class="subHeadingLabelClass">Create Material Issuance Form</h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label class="sf-label">Material Request Detail</label>
                                                ...
                                                <select class="form-control requiredField" required name="material_request_no" id="material_request_no" onchange="loadStoreChallanDetailByMRNo()">
                                                    ...
                                                    <?php foreach($materialRequestDatas as $row){?>
                                                        <option value="<?php echo $row->material_request_no.'<*>'.$row->material_request_date?>"><?php echo 'MR No => &nbsp;&nbsp;&nbsp;'.$row->material_request_no.'&nbsp;, MR Date => &nbsp;&nbsp;&nbsp;'.date('d-m-Y',strtotime($row->material_request_date))."&nbsp;&nbsp;&nbsp;".$row->username?></option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function loadStoreChallanDetailByMRNo(){
            ...
            if(mrNo == ''){
                ...
                $.ajax({
                    url: '<?php echo url('/')?>/store/makeFormStoreChallanDetailByMRNo',
                    type: "GET",
