                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <?php echo Form::open(array('url' => 'pad/addStockTransfer?m=' . $m . '', 'id' => 'addPurchaseReturnDetail', 'class' => 'stop'));?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input type="text" id="tr_no" name="tr_date" value="{{strtoupper($uniq)}}"
                                                    class="form-control requiredField" readonly>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <label for="">Transfer Date</label>
                                                <input type="date" class="form-control requiredField" id="tr_date"
                                                    name="tr_date" value="<?php echo date('Y-m-d')?>">
                                            </div>
                                                    ...
                                                    <table class="table table-bordered sf-table-list">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">Location From
                                                                </th>
                                                                <th class="text-center">Batch Code
                                                                </th>
                                                                ...
                                                                <th class="text-center">Location To
                                                                </th>
                                                        ...
                                                        <tbody id="AppendHtml">
                                                            <tr class="text-center AutoNo">
                                                                <td>
                                                                    <select style="width: 100%" onchange="get_sub_item('category_id1')" name="category" id="category_id1"  class="form-control category select2 requiredField">
                                                                ...
                                                                <td>
                                                                    <select style="width: 100%" name="item_id[]" id="item_id1" class="form-control requiredField select2">
                                                                        <option>Select</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select onchange="get_stock_qty(this.id,'1')"
                                                                        name="warehouse_from[]" id="warehouse_from1"
                                                                        class="form-control requiredField"
                                                                        style="width: 180px;">
                                                                        <option value="">Select Warehouse</option>
                                                                        <?php foreach (CommonHelper::get_all_warehouse() as $Fil):?>
                                                                        <option value="<?php    echo $Fil->id?>">
                                                                            <?php    echo $Fil->name?></option>
                                                                        <?php endforeach;?>
                                                                    </select>
                                                                </td>

                                                                <td><select onchange="get_stock_qty(this.id,1)"
                                                                        class="form-control requiredField"
                                                                        name="batch_code[]" id="batch_code1">
                                                                        <option value="">
                                                                            Select&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        </option>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="in_stock_qty[]"
                                                                        id="in_stock_qty1"
                                                                        class="form-control requiredField" readonly>
                                                                </td>
                                                                <td>
                                                                    <input onkeyup="check_qty(this.id,1)" type="text"
                                                                        name="qty[]" id="qty1"
                                                                        class="form-control requiredField SendQty"
                                                                        step="any" min>
                                                                </td>
                                                                <td style="display: none">
                                                                    <input readonly type="number" name="rate[]" id="rate1"
                                                                        class="form-control">
                                                                </td>
                                                                <td style="display: none">
                                                                ...
                                                                <td>
                                                                    <select name="warehouse_to[]" id="warehouse_to1"
                                                                        class="form-control requiredField"
                                                                        style="width: 180px;">
                                                                        <option value="">Select Warehouse</option>
                                                                        <?php foreach (CommonHelper::get_all_warehouse() as $Fil):?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    id="BtnAddMore" onclick="AddMoreRows()"><span class="glyphicon glyphicon-plus-sign"></span></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
    ...
    <script>
        ...
        function AddMoreRows() {
            ...
            $('#AppendHtml').append('<tr class="text-center AutoNo" id="RemoveRow' + Counter + '">' +
                '<td>' +
               '<select style="width: 100% !important;" onchange="get_sub_item("category_id'+Counter+'")" name="category" id="category_id'+Counter+'"  class="form-control category select2">'+
                '<option value="">Select</option>'+
               '@foreach (CommonHelper::get_all_category() as $category):'+
               '<option value="{{ $category->id }}"> {{ $category->main_ic }} </option>'+
               '@endforeach'+
               ...
               '</td>' +
                '<td>' +
                '<select onchange="get_stock_qty(this.id,' + Counter + ')" name="warehouse_from[]" id="warehouse_from' + Counter + '" class="form-control" style="width: 180px;">' +
                '<option value="">Select Warehouse</option>' +
                <?php foreach (CommonHelper::get_all_warehouse() as $Fil):?>
        ...
        function getStock1(datas, number) {
            var warehouse = $('#warehouse_from' + number).val();
            var batch_code = $('#batch_code' + number).val();

            var item = $('#item_id' + number).val().split('@');
            let item_id = item[0];

            $.ajax({
            url: '<?php echo url('/')?>/selling/getStockForTransfer',
            type: 'Get',
            data: {
                id: item_id,
            ...
            success: function (data) {
                $('#in_stock_qty' + number).val(data.qty);
                $('#rate' + number).val(data.rate);
            }
        });
    }
    
    function get_stock_qty(datas, number) {
        var warehouse = $('#warehouse_from' + number).val();
