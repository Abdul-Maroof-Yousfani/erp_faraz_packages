...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="dp_sdw">    
            ...
            {{ Form::open(array('url' => 'stad/addPurchaseRequestDetail?m='.$m.'','id'=>'addPurchaseRequestDetail', 'method' => 'POST')) }}
            <?php
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <span class="rflabelsteric"><strong>*</strong></span>
                                    <input type="text" name="sub_department_name" id="sub_department_name" class="form-control" readonly value="{{ CommonHelper::get_sub_dept_name($dept_id) }}" >
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <select required onchange="get_address()" name="supplier_id" id="supplier_id" class="form-control requiredField select2">
                                        ...
                                        <option @if($vendor_id == $row1->id)selected @endif value="<?php echo $row1->id.'@#'.$address.'@#'.$row1->ntn.'@#'.$row1->terms_of_payment.'@#'.$row1->strn.'@#'.($row1->no_of_days ?? '')?>"><?php echo ucwords($row1->name)?></option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <select required onchange="claculation(1);getrate();" name="curren" id="curren" class="form-control select2 requiredField">
                                        ...
                                        @foreach(CommonHelper::get_all_currency() as $row)
                                            <option @if($row->id == 3) selected @endif data-value="{{ $row->rate }}" value="{{$row->id.','.$row->rate}}">{{$row->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <input required type="date" class="form-control requiredField" name="due_date" id="due_date" min="{{ date('Y-m-d') }}" value="" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="table-responsive">
                                ...
                                foreach ($data as $key => $row) { ?>
                                    ...
                                    <tr id="removeSelectedPurchaseRequestRow_<?php echo $counter1;?>" class="text-center">
                                        ...
                                        <input type="hidden" name="demand_data_id<?php echo $counter1;?>"  id="demand_data_id<?php echo $counter1;?>" value="{{$row->id}}">
                                       ...
                                       // echo "<pre>"; print_r($sub_ic_detail); die;
                                        ...
                                        <td class="text-center">
                                            <input onkeyup="claculation('<?php echo  $counter1 ?>')" type="text" name="purchase_approve_qty_<?php echo $counter1?>" id="purchase_approve_qty_<?php echo $counter1?>" class="form-control requiredField approveQty" min="1" value="{{$row->qty}}" />
                                        </td>
                                        <td class="text-center">
                                            <input onkeyup="claculation('<?php echo $counter1 ?>')" type="text" name="rate_<?php echo $counter1?>" id="rate_<?php echo $counter1?>" class="form-control requiredField ApproveRate" step="any" value="{{ $rate }}" />
                                        </td>

                                        <td class="text-center hide">
                                            <input  readonly style="text-align: right" type="text" name="amount_<?php echo $counter1?>" id="amount_<?php echo $counter1?>" class="form-control requiredField amount text-right" min="1" value="{{$total = $rate * $row->qty}}" step="any" />
                                        </td>
                                        <td class="text-center hide">
                                        ...
                                        <td class="text-center">
                                            <input readonly class="form-control net_amount_dis" type="text" value="{{ $rate * $row->qty}}" name="after_dis_amountt_<?php echo $counter1?>" id="after_dis_amountt_<?php echo $counter1?>"/>
                                        </td>
                                    ...
                                    <td>
                                        <select onchange="sales_tax(this.id);open_sales_tax(this.id)" class="form-control select2" id="sales_taxx" name="sales_taxx">
                                            ...
                                            @foreach(ReuseableCode::get_all_sales_tax() as $row)
                                                ...
                                                <option @if ($sales_tax==$row->rate) selected @endif  value="{{$row->rate}}">{{$row->rate}} %</option>
                                            @endforeach
                                        </select>
                                    </td>
