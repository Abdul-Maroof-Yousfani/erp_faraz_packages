    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; Create Company Group</h3>
                </li>
            </ul>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                            ...
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">Create Company Group</h2>
                        </div>
                                <form action="{{route('companyGroupStore')}}" method="POST">
                                        ...
                                        <div class="row qout-h">
                                            ...
                                            <div class="col-md-12 padt pos-r">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                      <input type="text" class="form-control" name="location_name" id="">                                                    </div>
                                                    </div>  
                                                </div>
