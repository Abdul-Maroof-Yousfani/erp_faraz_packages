	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="dp_sdw">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="headquid"><span class="subHeadingLabelClass">Create Cash RECEIPT Voucher Form</span></div>
											...
											<table class="userlittab table sf-table-list">
												...
												<tbody class="addAmountTr" id="addAmountTr">
													<tr>
														...
														<td>
															<input placeholder="Debit" class="form-control d_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="d_amount_1_1" onkeyup="sum('1');syncCashRvAmount()" onchange="syncCashRvAmount()" value="" required="required"/>
														</td>
													</tr>
												</tbody>        
											</table>
