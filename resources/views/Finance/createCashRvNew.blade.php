        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well_N">
                <div class="dp_sdw">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class='headquidd'><span class="subHeadingLabelClass">Create Cash Receipt Voucher
                                    Form</span></div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                            ...
                                            <input readonly type="text" class="form-control requiredField"
                                                placeholder="Slip No" name="" id="" value="{{strtoupper($crv_no)}}" />
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                            ...
                                            <input autofocus onblur="" onchange="" type="date"
                                                ...
                                                name="rv_date_1" id="jv_date_1" value="<?php echo date('Y-m-d') ?>" />
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                                            <label class="sf-label">Ref / Bill No.</label>
                                            <span
                                                style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>
                                            <input autofocus onblur="" onchange="" type="text" class="form-control"
                                                max="<?php echo date('Y-m-d') ?>" name="ref_bill_no_1" id="ref_bill_no_1"
                                        ...
                                        {{--<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">--}}
                                            ...
                                            {{--<span
                                                style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>--}}
                                            {{--<input autofocus onblur="" onchange="" type="text"
                                                class="form-control requiredField" name="cheque_no_1" id="cheque_no_1"
                                        ...
                                        {{--<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">--}}
                                            ...
                                            {{--<span
                                                style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>--}}
                                            {{--<input autofocus onblur="" onchange="" type="date"
                                                class="form-control requiredField" max="" name="cheque_date_1"
                                                id="cheque_date_1" value="" />--}}
                                            {{--</div>--}}
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <div class='jhed headquid'>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <span class="subHeadingLabelClass">Cash Receipt Voucher
                                                                Detail</span>
                                                        </div>

                                                        <div class="col-md-6 text-right">
                                                            <input type="button" class="btn btn-sm btn-primary"
                                                                onclick="AddMoreRvs()" value="Add More RV's Rows" />
                                                        </div>
                                                    </div>
                                                ...
                                                <table id="buildyourform" class="table table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center hide" style="width:250px;">Received
                                                                By<span class="rflabelsteric"><strong>*</strong></span></th>
