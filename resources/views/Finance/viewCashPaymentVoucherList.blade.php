...
$export=ReuseableCode::check_rights(226);
...
@section('content')
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="well">
							...
							<div class="row">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
									<input type="button" value="Search" class="btn btn-primary" onclick="GetCpvsDateAndAccontWise();" style="margin-top: 32px;" />
								</div>
							</div>
																		...
																		<div class="dropdown">
																			...
																			<ul class="dropdown-menu">
																				<li>
																						...
																						<?php if($view == true):?>
																						<a onclick="showDetailModelOneParamerter('fdc/viewBankPaymentVoucherDetail','<?php echo $row1->id;?>','View Cash P.V Detail','<?php echo $_GET['m']?>')" class=""><i class="fa-regular fa-eye"></i> View</a>
																						<?php endif;?>
																						<?php if($edit == true):?>
																						<a href="<?php echo url('finance/editCashPVForm/'.$row1->id.'?m='.$m); ?>" type="button" class=" BtnHide<?php echo $row1->pv_no?>"><i class="fa-solid fa-pencil"></i> Edit</a>
																						<?php endif;?>
																						<?php if($delete == true):?>
																						<a class=" BtnHide<?php echo $row1->pv_no?>" type="button" onclick="DeletePvActivity('<?php echo $row1->id;?>','<?php echo $row1->pv_no?>','<?php echo $row1->pv_date?>','<?php echo CommonHelper::GetAmount('new_pv_data',$row1->id)?>')"><i class="fa-solid fa-trash"></i> Delete</a>
																						<?php endif;?>
																							<a target="_blank" href="<?php echo url('fdc/viewBankPaymentVoucherDetailPrint?id='.$row1->id.'&&m='.$m)?>" class=""><i class="fa-solid fa-print"></i> Print</a>
																					<?php
																						/*
																					if($row1->pv_status == 1):
	...
	<script>
		...
		function GetCpvsDateAndAccontWise()
		{
			...
			$.ajax({
				url: '/fdc/getCpvsDateAndAccontWise',
				type: 'Get',
