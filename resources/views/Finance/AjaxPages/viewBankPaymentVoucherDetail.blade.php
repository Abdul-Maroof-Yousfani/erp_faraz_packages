...
?>
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right" style=" display: flex; flex-direction: row; justify-content: flex-end;">
        ...
        @endif
        <div class="dropdown" >
            <button class=" btn btn-primary " type="button" data-toggle="dropdown" aria-expanded="false"> Print Cheque </button>
            <ul class="dropdown-menu">
                <li>
                    <a class="btn btn-primary prinn" target="new" href="{{ route('PaymentVoucherCheque', ['id' => $id, 'type' => 'normal']) }}">Normal</a>
                </li>
                <li>
                    <a class="btn btn-primary prinn" target="new" href="{{ route('PaymentVoucherCheque', ['id' => $id, 'type' => 'cross']) }}">Cross</a>
                </li>
                <li>
                    <a class="btn btn-primary prinn" target="new" href="{{ route('PaymentVoucherCheque', ['id' => $id, 'type' => 'cash']) }}">Cash</a>
                </li>
            </ul>
        </div>
        @if($Type !='audit_trial')
                            ...
                            <div class="table-responsive">
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center hide">Cost Center</th>
                                        ...
                                        <th class="text-center hide">Description</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hide"><?php  echo $row2->description; ?></td>
