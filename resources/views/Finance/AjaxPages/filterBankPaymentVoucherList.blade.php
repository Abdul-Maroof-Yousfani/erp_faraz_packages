...
$pvs = DB::table('pvs')
    ...
    ->where('pvs.status',1)
    ->whereIn('pvs.is_official', CommonHelper::getOfficialScopeArray())
        ...
        <td class="text-center hidden-print">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a onclick="showDetailModelOneParamerter('fdc/viewBankPaymentVoucherDetail','<?php echo $row1->id;?>','View Bank P.V Detail')" class=""><span class="glyphicon glyphicon-eye-open"> V</span></a>
                        <?php if ($row1->payment_type==1):?>
                        <a href="<?php echo  URL::to('/finance/editBankPaymentVoucherForm/'.$row1->id.'?m='.$m); ?>" type="button" class="">Edit</a>
                        <?php endif;?>
                        <?php
                        if($row1->pv_status == 1):
                        ...
                        $ActivityType = 2;
                        ?>
                        <a class="" onclick="DeletePvActivity('<?php echo $PvId;?>','<?php echo $PvNo;?>','<?php echo $UserName;?>','<?php echo $DeleteDate;?>','<?php echo $DeleteTime;?>','<?php echo $ActivityType;?>')"> Delete</a>
                        <?php endif?>
