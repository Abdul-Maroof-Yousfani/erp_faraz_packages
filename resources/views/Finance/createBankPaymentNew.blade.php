                                        ...
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="userlittab table table-bordered sf-table-list">
                                                ...
                                                <tr class="AutoNo">
                                                    ...
                                                    <td>
                                                        <input onfocus="('d_amount_1_<?php echo $j ?>');" placeholder="Debit" class="form-control d_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="d_amount_1_{{$j}}" onkeyup="sum('1')" value="" required="required"/>
                                                    </td>
                                                     <td class="">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:150px;">
                                                         <input type="number" readonly="readonly" id="c_t_amount_1" maxlength="15" min="0" name="c_t_amount_1" class="form-control requiredField text-right">
                                                    </td>
                                                   
                                                    <td class="diff" style="width:150px;font-size: 20px;">
                                                        <input readonly style="color: blue;font-weight: 600" class="form-control" type="text" id="diff"/>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
    ...
    <script>
        ...
        function AddMorePvs()
        {
            ...
            <tr class='AutoNo' id='tr${x}' >
                    <td>
                        <select class='form-control requiredField select2' onchange='Datavalidate(this)' name='account_id[]' id='account_id"+x+"'>
                            ...
                            <?php foreach(CommonHelper::get_all_account_operat() as $Fil){?>
                                <option value=<?php echo $Fil->id.',1'.','.$Fil->code?>'><?php echo $Fil->code.'--'.$Fil->name;?></option><?php }?>
                            </select>
                    </td>
                    <td class='hide'>
                    ...
                    <td>
                    <input  placeholder="Debit" class="form-control d_amount_1_${x} d_amount_'+x2+' requiredField" onfocus="" maxlength="15" min="0" type="any" name="c_amount[]" id="d_amount_1_${x}" onkeyup="sum('1')" value="" required="required"/>
                    </td>  
                     <td class=''>
                ...
                <tr class='AutoNo' id='remove_${amount_input}' >
                    <td>
                        <select class='form-control requiredField select2' onchange='Datavalidate(this)' name='account_id[]' id='account_id${amount_input}'>
                            <option value=''>Select Account</option>
                            <?php foreach(CommonHelper::get_all_account_operat_with_unique_code('1-2') as $Fil){?>
