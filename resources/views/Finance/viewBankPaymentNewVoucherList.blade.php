                        ...
                        <div class="well">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <input type="button" value="Search" class="btn btn-primary" onclick="GetBpvsDateAndAccontWise();" style="margin-top: 32px;" />
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="userlittab table table-bordered sf-table-list" id="TableExportToCsv1">
                                                                ...
                                                                <tr @if ($row1->type==2) style="background-color: darkgray" @endif
                                                                    ...
                                                                    <td class="text-center status{{$row1->pv_no}}"><?php if($row1->pv_status == 2){echo "<span style='color:green;'>Approved</span>";} else{echo "<span style='color:orange;'>Pending</span>";}?></td>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li>
                                                                                    ...
                                                                                    <?php endif;?>
                                                                                    <?php if($delete == true):?>
                                                                                    <a class="BtnHide<?php echo $row1->pv_no?>" type="button"
