...
$crv_no=CommonHelper::uniqe_no_for_rvs(date('y'),date('m'),1);
?>
...
@section('content')
	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="dp_sdw">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="headquid"><span class="subHeadingLabelClass">Create Bank RECEIPT Voucher Form</span></div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
									...
									<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
										...
										<span style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>
										<input autofocus onblur="" onchange=""  type="date" class="form-control requiredField" max="<?php echo date('Y-m-d') ?>" name="rv_date_1" id="pv_date_1" value="<?php echo date('Y-m-d') ?>" />
									</div>
														...
														<td>
															<select  style="width: 100%"  class="form-control requiredField select2" onchange="Datavalidate(this)" name="account_id[]" id="account_id">
																...
																@foreach(CommonHelper::get_all_account_operat_with_unique_code('1-2-1') as $key => $y)
																	<option value="{{ $y->id.',1,'.$y->code }}">{{ $y->code .' ---- '. $y->name }}</option>
																@endforeach
															</select>
														</td>
														<td>
															<input placeholder="Debit" class="form-control d_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="d_amount_1_1" onkeyup="sum('1');syncBankRvAmount()" onchange="syncBankRvAmount()" value="" required="required"/>
														</td>
													</tr>
												</tbody>        
											</table>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class='jhed headquid'>
											<div class="row">
												<div class="col-md-6">
													<span class="subHeadingLabelClass">Bank Receipt Voucher Detail</span>
												</div>
										...
										<div class="table-responsive">
											<table id="buildyourform" class="userlittab table table-bordered sf-table-list">
												...
												<tr class="AutoNo">
													...
													<td>
														<input placeholder="Credit" class="form-control c_amount_1 requiredField number_format" maxlength="15" min="0" type="text" name="c_amount[]" id="c_amount_1_{{$j}}" onkeyup="sum('1')" value="" required="required"/>
													</td>
													<td >
	...
	<script>
		...
		function syncBankRvAmount() {
			var amount = $('#d_amount_1_1').val();

			if ($('#c_amount_1_1').length) {
				$('#c_amount_1_1').val(amount);
			}
                ...
                <tr class='AutoNo' id='remove_${amount_input}' >
                    ...
                    <td>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 addAmountRow" id="remove_${amount_input}">
                                ...
                                <input placeholder="Debit" class="form-control d_amount_1 number_format" onfocus="d_amount_1_${amount_input}')" maxlength="15" min="0" type="any" name="c_amount[]" id="d_amount_1_${amount_input}" onkeyup="sum('1')" value="">
