                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <?php if($row1->payment_type == 1 && $row1->pv_status == 2):?>
                                                                                                <div>
                                                                                            <?php if($return == true):?>
                                                                                                <a class="dropdown-item_sale_order_list dropdown-item BtnReturn<?php echo $row1->pv_no?>" style="background-color: blue; color: white;" type="button" onclick="VoucherReturn('<?php echo $row1->id;?>','<?php echo $row1->pv_no?>','<?php echo $row1->pv_date?>','<?php echo CommonHelper::GetAmount('new_pv_data',$row1->id)?>','<?php echo $row1->cheque_no?>')"><i class="fa-solid fa-rotate-left"></i> Return</a>
                                                                                                <?php endif;?>
                                                                                            </div>
                                                                                            <div>
                                                                                            <?php endif;?>
