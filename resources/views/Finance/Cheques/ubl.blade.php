...
.date{position:absolute;top:100px;right:74px;font-size:21px;letter-spacing:2px;}
.pay{position:absolute;top:128px;left:74px;font-size:17px;font-weight:600;}
.wordrupees{position:absolute;top:157px;left:106px;font-size:17px;font-weight:600;}
.numericrupees{position:absolute;top:155px;right:142px;font-size:17px;font-weight:600;}
.rotate{}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @endif
                                            ...
                                            <div class="rotate">
                                                ...
                                                <div class="numericrupees">PKR {{ $amount }}</div>
                                            </div>
                                        </div>
