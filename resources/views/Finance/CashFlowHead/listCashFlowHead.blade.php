...
@section('content')
    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; Cash Flow Head List</h3>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel">
                            <div class="panel-body">
                            <div class="headquid">
                           <h2 class="subHeadingLabelClass">View Cash Flow Head List </h2>
                        </div>
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="">
    ...
    $(document).ready(function(){
         ...
         function viewCashFlowHead()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/Finance/CashFlowHead/',
                type: 'Get',
                data: {
                        rate_date:rate_date,
                        to_date:to_date
