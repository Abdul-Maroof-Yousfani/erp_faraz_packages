                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                            <div class="panel-body">
                                <form action="{{ route('CashFlowSubHead.update', $CashFlowHead->id) }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="cash_flow_head" class="form-control select2" id="cash_flow_head">
                                                                        @foreach ($parent_head as $row)
                                                                            <option value="{{$row->id}}" {{$CashFlowHead->cash_flow_head_id == $row->id ? 'selected' : ''}}>{{$row->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
