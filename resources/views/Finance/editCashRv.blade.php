                                        ...
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <tr class="text-center">
                                                    <th colspan="1" class="text-center">Cash Receipt Voucher Detail</th>
                                                ...
                                                <tr>
                                                    ...
                                                    </th><th class="text-center hide" style="width:250px;">Received By<span class="rflabelsteric"><strong>*</strong></span></th>
                                                ...
                                                <tr class="AutoNo" id="tr<?php echo $j?>">
                                                    ...
                                                    <td class="hide">
                                                        <textarea class="form-control" name="desc[]" id="desc_1_{{$j}}" required="required"/><?php echo $val->description?></textarea>
                                                    </td>
                                                    <td>
    ...
    <script>
        ...
        function AddMorePvs()
        {
            ...
            $('#addMorePvsDetailRows_1').append("<tr class='AutoNo' id='tr"+x+"'>"+
                    ...
                    "</td>"+
                    "<td class='hide'>"+
                    '<textarea class="form-control" name="desc[]" id="desc_1_'+x+'" required="required"/> </textarea>'+
                    "</td>"+
                    "<td>"+
