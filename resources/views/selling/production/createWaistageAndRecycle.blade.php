...
@section('content')
    ...
    ?>
    <style>
    tbody.disabled{opacity:0.5;/* You can adjust the styling for disabled rows */
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="headquid bor-bo">
                                        <h2 class="subHeadingLabelClass">Create Waistage and Recycle</h2>
                                    </div>
                                    <form action="{{ route('storeWaistageAndRecycle') }}" method="post">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <div class="select_button padt ">
                                            <div class="row">
                                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 {{-- cus-tab --}}">
                                                <div class="row">
                                                    <div class="qout-h wastage_detail">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    ...
                                                                                    <select onchange="work_change(this)" name="item_id[]"
                                                                                        ...
                                                                                        {{-- @foreach (CommonHelper::get_item_by_category(7) as $value)
                                                                                            <option value="{{ $value->id }}">
                                                                                                {{ $value->sub_ic }}</option>
                                                                                        @endforeach --}}
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <label for="">Qty.</label>
                                                                                    <input type="text" name="qty[]" onkeyup="cal_qty()"
                                                                                        value=""
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="rowData">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <label for="">Item </label>
                                                                                <select onchange="work_change(this)" name="output_item_id"
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input type="text" name="output_batch_code"
                                                                                    value="" class="form-control output_batch_code">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label for="">Wastage Date.</label>
                                                                                <input type="date" name="wastage_date" value=""
                                                ...
                                                <div class="qout-h recycle_detail " style="display: none">
                                                    <div class="row" >
                                                        <div class="col-md-12 padt ">
                                                            <div class="row">
                                                                        ...
                                                                        <div class="rowData">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <label for="">Item </label>
                                                                                    <select onchange="getStock1(this)"
                                                                                        style="width: 100%;" name="recycle_item_id[]"
                                                                                        id="recycle_item"
                                                                                        class="form-control recycle_item">
                                                                                        <option value="">Select Item</option>
                                                                                        {{-- @foreach (CommonHelper::get_item_by_category(7) as $value)
                                                                                            <option value="{{ $value->id }}">
                                                                                                {{ $value->sub_ic }}</option>
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <label for="">Ware House </label>
                                                                                    <select onchange="getStock1(this)"
                                                                                        class="form-control warehouse_id select2"
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    ...
                                                                                    <input type="number" readonly name="stock_qty[]"
                                                                                        value="" class="form-control stock_qty">
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <label for="">Qty.</label>
                                                                                    <input type="number" onkeyup="cal_recycle_qty(this)"
                                                                                        name="recycle_qty[]" value=""
                                                                                        class="form-control recycle_qty ">
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="wegis">
                                                                                        <label for=""></label>
                                                                                        <button onclick="addRecycleRow()" type="button"
                                                                                            class="btn btn-success mr-1" data-dismiss="modal">
                                                                                            Add more
                                                                                        </button>   
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div class="row ">
                                                                    <div class="col-md-12">
                                                                        <div class="row align-items-center">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                 <div class="wegiss">
                                                                                    <button onclick="addRecycleRow2()" type="button" class="btn btn-success mr-1" data-dismiss="modal">
                                                                                        Add more
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    {{-- <div class="col-md-12 rowData hide">
                                                                        <div class="col-md-3">
                                                                            <label for="">Item </label>
                                                                            <select onchange="getStock1(this)" style="width: 100%;"
                                                                                name="recycle_item_id[]" id="recycle_item"
                                                                                class="form-control recycle_item">
                                                                                <option value="">Select Item</option>
                                                                                @foreach (CommonHelper::get_item_by_category(7) as $value)
                                                                                    <option value="{{ $value->id }}">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <label for=""></label>
                                                                            <button onclick="addRecycleRow2()" type="button"
                                                                                class="btn btn-success mr-1" data-dismiss="modal">
                                                                                Add more
                                                                            </button>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="rowData">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label for="">Qty.</label>
                                                                            <input type="text" readonly name="recycle_output_qty"
                                                                                value=""
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <input type="date" name="recycle_date" value=""
                                                                                class="form-control recycle_date">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
