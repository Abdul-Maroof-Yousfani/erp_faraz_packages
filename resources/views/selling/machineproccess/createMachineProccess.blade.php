                                            ...
                                            <div class="row qout-h">
                                                <div class="col-md-12 bor-bo">
                                                    <div class="pips_create">
                                                        <h1>Create Machine Processing</h1>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 padt pos-r">
                                                    <div class="col-md-6">
                                                        <div class="form-group hide">
                                                            ...
                                                            <div class="col-sm-8 ">
                                                                <select name="so_id" onchange="productionPlanAgainstSo(this)"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="machine_id" id="machine_id" class="form-control" id="" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="operator_id" id="operator_id" class="form-control" id="" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select name="shift" id="shift" class="form-control" id="" required>
                                                        ...
                                                        <div class="form-group hide">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control requiredField" name="received_length" id="received_length" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label"
                                                                for="exampleDropdownFormEmail1">Bundle</label>
                                                            <div class="col-sm-8">
                                                                <input type="number" placeholder=""
                                                                    class="form-control requiredField" name="Bundle"
                                                                    id="Bundle" min="1" value="1">
                                                            </div>
                                                        </div>
                                                        <div class="form-group hide">
                                                            <label class="col-sm-4 control-label" for="exampleDropdownFormEmail1">Color Line</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control requiredField" name="color" id="color">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="exampleDropdownFormEmail1">Remarks</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control requiredField" name="remarks" id="remarks">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input readonly class="form-control" name="remaining" id="remaining" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="PrintPanel">
                                                    <div id="ShowHide">
                                                        <div class="table-responsive">
                                                            ...
                                                            <a onclick="delete_all()" class="btn btn-sm btn-danger"><i
    ...
    function delete_all() {
        ...
        if (flag) {
            $.ajax({
                ...
                type: 'POST',
                data: { id: id, machine_proccess_id: machine_proccess_id, batch_no: batch_no },
                success: function (response) {
                    if (response == 2) {
