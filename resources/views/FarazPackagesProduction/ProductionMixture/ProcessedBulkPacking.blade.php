                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <select required class="form-control select2 requiredField"
                                                                    ...
                                                                    <option value="cutting and sealing">Cutting And Sealing</option>
    ...
    <script>
        ...
        @endif
            ...
            function fetchRollingItems() {
                ...
                let cutting_type = $('#cutting_type').val();
                if (!productionOrderId && !cutting_type) {
                         ...
                         <div class="d-flex justify-content-between border-bottom pb-2 mb-3">
                            ...
                            <div class="row mb-3 align-items-end">
                                <div class="col-md-5">
                                    ...
                                    <input type="hidden" name="item_id[]" class="real-item-id aqib" value="${item.item_id}">
        ...
        function itemSelected(selectElement) {
            ...
            card.find('input[name="raw_item_id[]"]').val('');
            ...
            if (itemData) {
                ...
                card.find('input[name="raw_item_id[]"]').val(itemData.item_id);
