...
<div class="row" id="printRecipeDetail">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3 style="text-align: center;">Finish Good Formulation</h3>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div>
            <table class="table table-bordered table-condensed tableMargin">
                <tbody>
                    <tr>
                        <td>Formulation No:</td>
                        <td>{{ $recipe->formulation_no ?? '' }}</td>
                    </tr>
                    <tr>
                        <td>Recipe Name:</td>
                ...
                @if(!empty($recipe->recipeDatas))
                    @foreach ($recipe->recipeDatas as $key => $data)
                        <tr>
                            ...
                            <td class="text-center">{{ number_format($data->category_total_qty,2) }}</td>
                        </tr>
                    @endforeach
                @endif
            </tbody>
