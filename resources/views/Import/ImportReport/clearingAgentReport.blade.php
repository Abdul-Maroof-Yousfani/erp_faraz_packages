...
<div class="row well_N align-items-center">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table class="userlittab table table-bordered sf-table-list m-font">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="">Lot</th>
                                                    <th class="max-ww1">Bill Number</th>
                                                    <th class=" max-ww1">Bill Date</th>
                                                    <th class="">Bill Amount</th>
                                                    <th class="max-ww1">Deduction</th>
                                                    <th class="max-ww1">Total Paid</th>
    ...
    $(document).ready(function(){
         ...
         function viewExchangeRate()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/import/Report/clearingAgent',
                type: 'Get',
                data: {
                        rate_date:rate_date,
                        to_date:to_date
