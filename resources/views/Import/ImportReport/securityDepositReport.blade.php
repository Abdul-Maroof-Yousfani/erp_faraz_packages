...
<div class="row well_N align-items-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table class="userlittab table table-bordered sf-table-list m-font">
                                                <thead>
                                                <tr>
                                                    <th class="">File Referance</th>
                                                    <th class="max-ww1">LINE</th>
                                                    <th class="max-ww1">Forwarder</th>
                                                    <th class="max-ww1">LOT</th>
                                                    <th class="max-ww2">BL / AWB No</th>
                                                    <th class="max-ww2">BL / AWB Date</th>
                                                    <th class="max-ww2">Facory receiving Date</th>
                                                    <th class="">Over due</th>
                                                    <th class="max-ww1">Total</th>
                                                </tr>
                                            </thead>
                                            <tbody id="data">
    ...
    $(document).ready(function(){
         ...
         function viewExchangeRate()
        {
            ...
            $.ajax({
                url: '<?php echo url('/')?>/import/Report/securityDepositReport',
                type: 'Get',
                data: {
                        rate_date:rate_date,
                        to_date:to_date,
