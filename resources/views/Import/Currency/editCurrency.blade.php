    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp;Edit Currency</h3>
                </li>
            </ul>
        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                            <div class="panel-body">
                                <form action="{{route('Currency.store_update',$currency->id)}}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input name="name" id="name" value="{{$currency->name}}" class="form-control" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- <div class="col-md-4">
