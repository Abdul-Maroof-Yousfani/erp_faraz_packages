    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp; LC And LG List</h3>
                </li>
            </ul>
        </div>
    </div>
                                    ...
                                    <div class="row" style="margin-top:10px ;display:none">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <button type="button" class="btn btn-sm btn-primary"
                                                style="margin: 5px 0px 0px px;" onclick="viewLc();">Submit</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="headquid">
                                            <h2 class="subHeadingLabelClass">View LC And LG List </h2>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="">
