    ...
    <div class="row well_N align-items-center">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <ul class="cus-ul">
                ...
                <li>
                    <h3><span class="glyphicon glyphicon-chevron-right"></span> &nbsp;Create Exchange Rate</h3>
                </li>
            </ul>
        </div>
    </div>
                                                ...
                                                <div class=" qout-h">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="rate_date" id="rate_date"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="rate" id="rate" step="any"
                                                    ...
                                                    <div class="col-md-12 padtb text-right">
                                                        ...
                                                        <div class="col-md-3 my-lab">
                                                            ...
                                                            <a href="{{ route('ExchangeRate.cancel') }}"
