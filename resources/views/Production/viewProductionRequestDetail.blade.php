...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        @if($production_request->approval_status == 1 && $production_request->status == 1)
                <button class="btn btn-success btn-xs btn-abc hidden-print" onclick="approveAndRejectProductionRequest('{{ $production_request->id }}',2)">Approve</button>
                <button class="btn btn-danger-2 btn-xs btn-abc hidden-print" onclick="approveAndRejectProductionRequest('{{ $production_request->id }}',3)">Reject</button>
        @endif
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="well">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <h3 style="text-align: center;">Production Request</h3>
                </div>
