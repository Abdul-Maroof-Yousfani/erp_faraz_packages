        ...
        <div class="panel">
            <div class="panel-body">
                <div class="headquid">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="subHeadingLabelClass">Production Request List</h2>
                        </div>
                        ...
                        <div class="well">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="margin-top: 40px">
                                    <a href="#" class="btn btn-primary" onclick="viewProductionRequestListDetail();">Search</a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    viewProductionRequestListDetail();
    
    function viewProductionRequestListDetail() {
        var m = $('#m').val();
        ...
        $.ajax({
            url: '{{url('/production/viewProductionRequestListDetail')}}',
