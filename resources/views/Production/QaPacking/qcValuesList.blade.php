        ...
        <div class="panel">
            <div class="panel-body">
                <div class="headquid">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="subHeadingLabelClass">QC Values List</h2>
                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="userlittab table table-bordered sf-table-list"
                                                                ...
                                                                <tbody>
                                                                            ...
                                                                            <td class="text-center hidden-print">
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <ul class="dropdown-menu">
                                                                                        <li>
                                                                                            <a onclick="showDetailModelOneParamerter('Production/QaPacking/viewQcValuesDetail?m={{ $m }}','{{ $qcValue->id }}','View QC Values')"
                                                                                                type="button"
                                                                                                class="dropdown-item_sale_order_list dropdown-item ">View</a>

                                                                                            <a href="{{ route('Production.QaPacking.editQcValues', $qcValue->id) }}"
                                                                                                type="button"
                                                                                                class="dropdown-item_sale_order_list dropdown-item ">
                                                                                                Edit</a>

                                                                                            <a onclick="deleteQcValue('{{ $qcValue->id }}', '{{ $counter++ }}')"
                                                                                                type="button"
                                                                                                class="dropdown-item_sale_order_list dropdown-item ">
                                                                                                Delete</a>
                                                                                        </li>
                                                                    ...
                                                                    @empty
                                                                        <tr>
                                                                            <td colspan="6" class="text-center">No QC Values
                                                                                Found</td>
                                                                        </tr>
                                                                    @endforelse
                                                                </tbody>
...
<script>
    ...
    function deleteQcValue(id, row) {
        if (confirm("Are you sure you want to deactivate this QC Value?")) {
            $.ajax({
                url: '{{ url('/') }}/Production/QaPacking/deleteQcValue',
                type: 'POST',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}',
