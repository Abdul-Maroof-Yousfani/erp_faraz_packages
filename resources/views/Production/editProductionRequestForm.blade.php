        ...
        <div class="dp_sdw">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="headquid">
                        <h2 class="subHeadingLabelClass">Edit Production Request </h2>
                    </div>
                </div>
            </div>
            {{ Form::open(array('url' => 'prad/editProductionReuestDetail?m=' . $m . '', 'id' => 'productionReuestDetail' )) }}
