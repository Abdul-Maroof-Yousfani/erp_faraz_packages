...
@section('content')
                        ...
                        <div class="well">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <span class="subHeadingLabelClass">Mould Usage</span>
                                </div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive" id="append">
                                                        <table id="data_table" class="table table-bordered">
                                                            ...
                                                            <?php
                                                            $count=1;
                                                            $data=DB::Connection('mysql2')->select('select * from mould_usage_report where status=1 group by mould_id,batch_code_id');
    ...
    <script !src="">
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('Mould Usage <?php echo date('d-M-Y')?>.' + (type || 'xlsx')));
        }
    </script>
    <script type="text/javascript">
        ...
        function  data()
        {
            ...
            $.ajax({
                url: '<?php echo url('/');?>/production/get_mould_usage_report',
                type: 'GET',
