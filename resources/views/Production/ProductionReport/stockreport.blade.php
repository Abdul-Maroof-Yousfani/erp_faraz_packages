                                        ...
                                        <table class="userlittab table table-bordered sf-table-list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="2"  style="vertical-align: middle;" class="text-center" rowspan="2">QTY ON HAND</th>
                                                    <th colspan="2"  style="vertical-align: middle;" class="text-center" rowspan="2">UOM</th>
                                                    <th style="vertical-align: middle;" class="text-center" rowspan="2">UNITS</th>
                                                    <th style="vertical-align: middle;" class="text-center" rowspan="2">VALUATION</th>
                                                </tr>
                                                <tr>
