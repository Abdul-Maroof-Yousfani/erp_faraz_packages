...
.rp-btn{width:100%;border:none;padding:13px;border-radius:12px;background:linear-gradient(135deg,#FF7A45,#7C5CFC);color:#fff;font-weight:700;font-size:14.5px;cursor:pointer;margin-top:8px;box-shadow:0 10px 22px rgba(124,92,252,0.28);}
