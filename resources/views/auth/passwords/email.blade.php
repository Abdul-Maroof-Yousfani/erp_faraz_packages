...
.fp-icon { width: 56px; height: 56px; border-radius: 16px; background: linear-gradient(135deg, #FF7A45, #7C5CFC); display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; color: #fff; font-size: 22px; }
...
.fp-btn { width: 100%; border: none; padding: 13px; border-radius: 12px; background: linear-gradient(135deg, #FF7A45, #7C5CFC); color: #fff; font-weight: 700; font-size: 14.5px; cursor: pointer; box-shadow: 0 10px 22px rgba(124,92,252,0.28); }
