                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                ...
                                <td>{{ $sub_ic_detail[3] .' -- '.CommonHelper::get_item_name($row1->sub_item_id) }}</td>
                                <td> <?php echo CommonHelper::get_uom_name($sub_ic_detail[0]);?></td>

                                <td class="text-center"><?php echo number_format($row1->qty,2);?></td>
                                <td class="text-center">{{ $row1->purpose }}</td>
                                <td class="text-center">{{ CommonHelper::changeDateFormat($row1->required_date) }}</td>
