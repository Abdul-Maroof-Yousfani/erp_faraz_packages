                                            ...
                                            <div class="sal">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-7">
                                                        <div class="ors_pra">
                                                            <p>{{$mainData->supplier_name ?? 'N/A'}}</p>
                                                            <p>{{$mainData->grn_no ?? 'N/A'}}</p>
                                                            <p>{{$mainData->grn_date ? date("d-M-Y", strtotime($mainData->grn_date)) : 'N/A'}}</p>
                                                            <p>{{$mainData->sub_ic ?? 'N/A'}}</p>
                                                            <p>
                                                                {{$mainData->qc_grn_date ? date("d-M-Y", strtotime($mainData->qc_grn_date)) : 'N/A'}}
                                                            </p>
                                                            <p>{{$mainData->batch_code ?? 'N/A'}}</p>
                                                            <p>{{$mainData->qc_by ?? 'N/A'}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="userlittab3 table table-bordered sf-table-list3">
                                                    ...
                                                    <tbody id="data">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                {{$value->standard_value ?? 'N/A'}}
                                                            </td>
                                                            <td class="text-center">
                                                                {{$value->test_value ?? 'N/A'}} - {{$value->remarks ?? 'N/A'}}
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                        @endif
                                                        ...
                                                        @if(count($chemicaltest) > 0)
                                                        @php $count = 1; @endphp
                                                        <tr>
                                                            <th colspan="4" class="">Chemical Characteristic</th>
                                                        </tr>
                                                        @foreach($chemicaltest as $key => $value)
                                                        <tr>
                                                            <td class="text-center">
                                                                {{$count++}}
                                                            </td>
