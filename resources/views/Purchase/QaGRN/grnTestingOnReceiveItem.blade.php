                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="panel">
                            <div class="panel-body">
                                <form action="{{route('QaGrn.storeTestResult')}}" method="post">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody id="more_details">
                                                                @foreach($items as $key => $value)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="hidden" name="grn_data_id[]" value="{{ $value->id }}">
                                                                            {{ $i++ }}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <table>
                                                                                <tr>
                                                                                    <td>{{ $test_column_value->remarks ?? 'N/A' }}</td>
                                                                                    <td>
                                                                                        <input type="hidden" name="qa_test_id{{ $value->id }}[]" value="{{ $test_column_value->id }}">
