                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <form action="{{route('QaGrn.store')}}" method="post" id="qaGrnForm" onsubmit="return validateQcForm()">
                                                    ...
                                                    <div class="col-md-12 padt pos-r">
                                                        <div class="col-md-6">
                                                                    ...
                                                                    <select name="grn_id" class="form-control" id="grn_id" onchange="loadGrnDataItems(this.value);">
                                                                        ...
                                                                        @foreach($grns as $key => $val)
                                                                            <option value="{{ $val->id }}" 
                                                                                ...
                                                                                data-grn_no="{{ $val->grn_no }}"
                                                                                data-grn_date="{{ $val->grn_date }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="qc_grn_date" value="{{date('Y-m-d')}}"
...
<script>
    ...
    function getQcValueForm(grn_id) {
        $.ajax({
            url: '{{ url('/') }}/purchase/QaGrn/grnViewQaGrnDetail',
            type: 'Get',
            data: { grn_id: grn_id },
            success: function (data) {
                $('#addQCForm').html(data);
