                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input onkeyup="" type="text" class="form-control" placeholder="Ref / Bill No" name="slip_no" id="slip_no"
                                                       value=""/>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="headquid">
                                            <h2 class="subHeadingLabelClass">Purchase Order Detail</h2>
                                       </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <table class="table ">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center hide">Uom<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th class="text-center hide"> QTY<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th class="text-center hide">Rate<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th style="width:18%" class="text-left">Amount<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th class="text-left hide">Discount %<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th class="text-left hide">Discount Amount<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th class="text-left hide">Net Amount<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <th  class="text-left">Delete<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    </tr>
                                                </thead>
                                                <tbody id="AppnedHtml">
                                                    <tr title="1" class="AutoNo">
                                                        <td>
                                                            <select name="item_id[]" id="sub_1" onchange="itemChange(1)"class="form-control select2">
                                                                <option value="">Select</option>
                                                        ...
                                                        <td class="hide">
                                                            <input type="text" onkeyup="claculation('1')" onblur="claculation('1')"
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control requiredField number_format" name="amount[]"
                                                                id="amount1" onkeyup="amount_calculation('1')" placeholder="AMOUNT" min="1"
                                                                value="">
                                                        </td>
                                                        <td class="hide">
                                                ...
                                                <tbody>
                                                    <tr
                                                        ...
                                                        <td id="" class="text-left" colspan=""><input
                                                                readonly class="form-control number_format" type="text"
                                                                id="net" /> </td>
                                                        <td colspan="7"></td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="float: right;">
                                        <table class="table table-bordered sf-table-list sales_tax" style="background:#fff;">
                                            <thead>
                                                <th style="width:15%" class="text-left" >Sales Tax Account Head</th>
                                                <th  style="width:18%" class="text-left" >Sales Tax Amount</th>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td>
                                            ...
                                            <tbody>
                                                <tr style="font-size:large;font-weight: bold">
                                                    <td class="text-left">Total Amount After Tax</td>
                                                    <td id="" class="text-left">
                                                        <input readonly class="form-control number_format" type="text" id="net_after_tax" /> 
                                                    </td>
                                                    <td calspan="7"></td>
                                                </tr>
                                            </tbody>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered sf-table-list sales_tax">
                                                <thead>
                                                    <th style="width:15%" class="text-left">Account Head</th>
                                                    <th style="width:15%" class="text-left">Expense Amount</th>
                                                </thead>
            ...
            $('#AppnedHtml').append(`
                    <tr id="RemoveRows${Counter}" class="AutoNo">
                        ...
                        <td class="text-left" colspan="7">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" id="BtnRemove${Counter}" onclick="RemoveSection(${Counter})"> <i class="fa-solid fa-trash"></i> </button>
                            </td>
                    </tr>
            `);
    ...
    <script type="text/javascript">
        ...
        function AddMoreExpense()
        {
            ...
            $('#AppendExpense').append("<tr id='RemoveExpenseRow"+CounterExpense+"'>" +
                    "<td>"+
                    "<select class='form-control requiredField select2' name='account_id[]' id='account_id"+CounterExpense+"'><option value=''>Select Account</option><?php foreach(CommonHelper::get_accounts_by_parent_code('1-6') as $Fil){?><option value='<?php echo $Fil->id?>'><?php echo $Fil->code.'--'.$Fil->name;?></option><?php }?></select>"+
                    "</td>"+
                    "</td>" +
                    "<td>" +
