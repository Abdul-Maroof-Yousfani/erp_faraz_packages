            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr>
                            ...
                            <td class="text-center"> {{  CommonHelper::changeDateFormat($quotation_data[0]->demand_date)}} </td>
                        </tr>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr>
                            <td>Currency</td>
                            <td class="text-center">{{ CommonHelper::get_curreny_name($quotation->currency_id) }}</td>
                        </tr>
                        <tr>
                            <td>Currency Rate</td>
                            <td class="text-center">{{ $quotation->currency_rate }}</td>
                        </tr>
                ...
                <div class="table-responsive">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr class="tex-center">
                            ...
                            <td style="text-align: center">{{ $cur }} {{ number_format($row->rate,3) }}</td>
                            <td style="text-align: center">{{ $cur }} {{ number_format($row->amount,3) }}</td>
                        </tr>
                        ...
                        <tr class="text-center">
                            ...
                            <td style="text-align: center" colspan="1">{{ $cur }} {{ number_format($total_amount,2) }}</td>
                        </tr>
                       @if($quotation->gst_amount > 0)
                        <tr class="text-center">
                            <td class="bold" colspan="5">Sales Tax {{ number_format($quotation->gst).' %' }}</td>
                            <td style="text-align: center" colspan="1">{{ $cur }} {{ number_format($quotation->gst_amount,2) }}</td>
                        </tr>

                        <tr class="text-center">
                            <td class="bold" colspan="5">Total Amount With Tax</td>
                            <td style="text-align: center" colspan="1">{{ $cur }} {{ number_format($quotation->gst_amount + $total_amount,2) }}</td>
                        </tr>
                        @endif
                        </tbody>
                    </table>
