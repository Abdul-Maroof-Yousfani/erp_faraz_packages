                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                    <h2 class="subHeadingLabelClass">Vendor Details </h2>
                                                </div>
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <input readonly id="vendor_name" type="text" class="form-control requiredField" value="<?php echo PurchaseHelper::generateVendorCode()?>">
                                                            ...
                                                            <select onchange="get_nature_type()" name="account_head" id="account_id" class="form-control requiredField select2">
                                                                ...
                                                                @foreach($accounts as $key => $y)
                                                                    <option @if($y->code=='2-2-1') selected @endif value="{{ $y->code}}">{{ $y->code .' ---- '. $y->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <input readonly id="vendor_code" type="text" class="form-control requiredField" value="<?php echo PurchaseHelper::generateVendorCode()?>">
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label>Name :</label>
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <label>NTN :</label>
                                                                <input style="" placeholder="NTN" type="text" name="ntn" class="form-control" id="ntn"/>
    
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
    
                                                                <label>STRN :</label>
                                                                <input style="" placeholder="STRN" type="text" name="strn" class="form-control" id="strn"/>
