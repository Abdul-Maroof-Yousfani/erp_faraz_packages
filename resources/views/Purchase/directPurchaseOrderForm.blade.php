                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hide">
                                        ...
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <select class="form-control  select2" name="sub_department_id_1" id="sub_department_id_1">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Mode/ Terms Of Payment <span class="rflabelsteric"></span></label>
                                        <input onkeyup="calculate_due_date()" value="0"  type="number" class="form-control requiredField" placeholder="" name="model_terms_of_payment" id="model_terms_of_payment" value="" />
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Payment Due Date<span class="rflabelsteric"></span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" hidden>
                                        ...
                                        <input type="text" name="commission" id="commission" class="form-control " placeholder="">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hide">
                                        ...
                                        <input type="text" value="0" name="trn" id="trn" class="form-control" placeholder="TRN">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 hide">
                                ...
                                <div class="table-responsive" >
                                    <table class="table table-bordered">
                                        ...
                                        <tr class="text-center">
                                            <th colspan="5" class="text-center">Purchase Order Detail</th>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" >HS Code<span class="rflabelsteric"><strong>*</strong></span></th>
                                            ...
                                            <th class="text-center">Amount(PKR)<span class="rflabelsteric"><strong>*</strong></span></th>
                                            ...
                                            <th class="text-center">Net Amount(PKR)<span class="rflabelsteric"><strong>*</strong></span></th>
                                        ...
                                        <tbody id="AppnedHtml">
                                            <tr title="1" class="AutoNo">
                                                ...
                                                <td>
                                                    <input readonly type="text" class="form-control" name="hs_code_id[]" id="hs_code_id1" >
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control number_format" name="amount[]" id="amount1" placeholder="AMOUNT" min="1" value="" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control actual_amount number_format" name="actual_amount[]" id="actual_amount1" placeholder="AMOUNT" min="1" value="" readonly>
                                                </td>

                                                    <input type="hidden" onkeyup="discount_percent(this.id)" class="form-control " name="discount_percent[]" id="discount_percent1" placeholder="DISCOUNT" min="1" value="0">

                                                    <input type="hidden" onkeyup="discount_amount(this.id)" class="form-control " name="discount_amount[]" id="discount_amount1" placeholder="DISCOUNT" min="1" value="0">

                                                <td>
                                                    <input type="text" class="form-control net_amount_dis number_format" name="after_dis_amount[]" id="after_dis_amount1" placeholder="NET AMOUNT" min="1" value="0.00" readonly>
                                                </td>
                                        ...
                                        <tr  style="font-size:large;font-weight: bold">
                                            ...
                                            <td  class="text-right" colspan="1"><input readonly class="form-control number_format" type="text" id="pkr_net"/> </td>
                                            <td  class="text-right" colspan="1"><input readonly class="form-control number_format" type="text" id="actual_net"/> </td>
                                            <td  class="text-right" colspan="1"><input readonly class="form-control number_format" type="text" id="net"/> </td>
                                            <td></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <table class="table table-bordered sf-table-list">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"  colspan="3">
                                            <input onkeyup="tax_by_amount(this.id)" type="text" class="form-control number_format" name="sales_amount_td" id="sales_amount_td"/>
                                        </td>
                                    ...
                                    <tr  style="font-size:large;font-weight: bold">
                                        ...
                                        <td id="" class="text-right" colspan="3"><input readonly class="form-control number_format" type="text" id="net_after_tax"/> </td>
                                        <td></td>
                                    </tr>
                                    </tbody>
                                </table>
