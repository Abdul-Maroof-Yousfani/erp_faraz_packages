                                    ...
                                    <table class="userlittab table table-bordered sf-table-list">
                                       ...
                                       <tbody id="AppnedHtml">
                                          <tr class="AutoNo">
                                             ...
                                             <td>
                                                <input min="{{ date('Y-m-d') }}" type="date" class="form-control" name="required_date[]" id="required_date1">
                                             </td>
                                             <td class="hide">
...
<script>
   ...
   function AddMoreDetails()
   {
       ...
       $('#AppnedHtml').append(
               ...
               '<td><input type="date" min="{{ date('Y-m-d') }}" class="form-control" name="required_date[]" id="required_date'+Counter+'""> </td>' +
               '<td class="hide">' +
