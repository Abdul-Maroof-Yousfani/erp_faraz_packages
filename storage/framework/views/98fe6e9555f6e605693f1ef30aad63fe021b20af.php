...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hide">
        <?php if($approve==true): ?>
                <?php if($grn_status==1): ?>
                <button onclick="approve_grn(<?php echo e($row->id); ?>); btnDis()" id="BtnApproved"  type="button" class="btn btn-success btn-xs">Approve</button>
                <?php endif; ?>
        <?php endif; ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <?php echo  CommonHelper::displayPrintButtonInView('printGoodsReceiptNoteVoucherDetail','','1');?>
    </div>
</div>
                    ...
                    <div style="width:45%; float:right;">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr class="hidden-print">
                                <td>Attachment</td>
                                <td width=""><a target="_blank" href="<?php echo e(asset($row->file_path)); ?>"><?php echo e($row->file_path); ?></a></td>
                            </tr>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center">Qty<span class="rflabelsteric"></span></th>
                            ...
                            <?php
                           $item_name=  CommonHelper::get_item_name($row1->sub_item_id);
                            ?>
                            <tr>
                                <td style="text-align: center" title="<?php echo e($item_name); ?>">
                                ...
                                <td style="text-align: center"><?php echo $row1->batch_code?></td>
                                <td style="text-align: center"><?php echo  number_format($row1->purchase_recived_qty,2)?></td>
                                <td style="text-align: center"><?php echo  number_format($row1->rate,2)?></td>
                                <td style="text-align: center"><?php echo  number_format($row1->amount,2)?></td>
                        ...
                        <div>
                          ...
                          +$expense_data->sum('expense')+$expense_data->sum('other_expense');
                            ...
                            <p>Total Paid Amount : <?php echo e(number_format($bank_payment,2)); ?></p>
                            <p>Total Expense : <?php echo e(number_format($total_exp,2)); ?></p>
                        </div>
                    </div>
                </div>
                <?php else:?>
                    ...
                    <div class="table-responsive">
                        ...
                        $item_name= CommonHelper::getCompanyDatabaseTableValueById($m,'subitem','sub_ic',$row1->sub_item_id);
                            ...
                            <tr>
                                ...
                                <td <?php if($row->type==0): ?> <?php if($row1->purchase_recived_qty > $row1->purchase_approved_qty): ?>style="background-color: yellow"<?php endif; ?> <?php endif; ?> class="text-center"><?php echo number_format($row1->bal_reciable,2);?></td>
                        ...
                        <table style="display: none;"  id=""  class="table table-bordered tra">
                           ...
                           $data=  DB::Connection('mysql2')->table('transactions')->where('status',1)->where('voucher_no',$row->grn_no)->get();
                            ...
                            <tr>
                                ...
                                <td class="debit_amount text-right"><?php if($row1->debit_credit == 1): ?><?php echo e(number_format($row1->amount,2)); ?> <?php $total_debit+=$row1->amount  ?>  <?php endif; ?> </td>
                                <td class="debit_amount text-right"><?php if($row1->debit_credit == 0): ?><?php echo e(number_format($row1->amount,2)); ?> <?php $total_credit+=$row1->amount  ?>  <?php endif; ?> </td>
                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Account<span class="rflabelsteric"></span></th>
                                <th class="text-center">Amount<span class="rflabelsteric"></span></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $ExpCounter = 1;
