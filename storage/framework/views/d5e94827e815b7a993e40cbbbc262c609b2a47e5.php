                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                    <form action="<?php echo e(route('QaGrn.update', $QcGrn->id)); ?>" method="post" id="qaGrnForm" onsubmit="return validateQcForm()">
                                                    ...
                                                    <div class="col-md-12 padt pos-r">
                                                        <div class="col-md-6">
                                                                    ...
                                                                    <select name="grn_id" class="form-control" id="grn_id" onchange="getGrnDetails(this.value);" disabled>
                                                                        ...
                                                                        <?php $__currentLoopData = $grns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($val->id); ?>" 
                                                                                ...
                                                                                <?php echo e($QcGrn->grn_id == $val->id ? 'selected' : ''); ?>>
                                                                                <?php echo e($val->grn_no . " - " . $val->grn_date . " - " . ($val->supplier_name ?? '')); ?>

                                                                            </option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                    <input readonly name="grn_id" type="hidden" value="<?php echo e($QcGrn->grn_id); ?>">
                                                                    <input readonly name="po_no" id="po_no" class="form-control" type="hidden" value="">
                                                                    <input readonly name="supplier_id" id="supplier_id" class="form-control" type="hidden" value="<?php echo e($QcGrn->supplier_id); ?>">
                                                                    <input readonly name="new_pv_id" id="new_pv_id" class="form-control" type="hidden" value="<?php echo e($QcGrn->new_pv_id); ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" id="grn_data_item_group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <select name="grn_data_id" class="form-control" id="grn_data_id" onchange="getGrnDetails(<?php echo e($QcGrn->grn_id); ?>, <?php echo e($QcGrn->id); ?>);">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="qc_grn_date" value="<?php echo e($QcGrn->qc_grn_date); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="qc_by" value="<?php echo e($QcGrn->qc_by); ?>" class="form-control"
                                                                        type="text" required>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        var qc_grn_id = <?php echo e($QcGrn->id); ?>;
