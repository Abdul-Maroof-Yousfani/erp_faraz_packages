...
<?php
    ...
    <div class="row container-fluid">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center" style="border: solid 1px #ccc">
            <p><?php echo e(strtoupper($row->username)); ?> <span class="badge badge-primary">&nbsp;<?php echo e(' '.$row->countt); ?></span></p>
        </div>
        <?php endforeach;?>
    </div> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel" id="printPurchaseRequestVoucherList">
                                        <div class="panel-body">
                                            <?php echo CommonHelper::headerPrintSectionInPrintView($m);?>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered sf-table-list table-hover" id="data_table">
                                                            <thead>
                                                            <th class="text-center">S.No</th>
                                                            <th class="text-center">P.O. No.</th>
                                                            <th class="text-center">P.O. Date</th>
                                                            <th class="text-center hide">STRN </th>
                                ...
                                <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                                    <img src="data:image/png;base64, <?php echo base64_encode(QrCode::format('png')->size(200)->generate('View Purchase Request List (Office Use)')); ?> ">
                                </div> -->
                            </div>
                            </div>
                        </div>
...
<script src="<?php echo e(URL::asset('assets/custom/js/exportToExcelXlsx.js')); ?>"></script>
    <script>
        ...
        function getDataPoNoWise()
        {
            ...
            if(PoNo != '') {
                $('#PoNo').css('border', '');
                $('#filterPurchaseRequestVoucherList').html('<tr><td colspan="10"><div class="loader"></div></td><tr>');
                $.ajax({
                    url: '<?php echo e(url('/')); ?>/stdc/getPoDataPoNoWise',
                    type: 'Get',
                    data: {m:m,PoNo:PoNo},
                    success: function (response) {
