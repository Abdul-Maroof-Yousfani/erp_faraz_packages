...
$icons = [
    ...
    <div id="mySidenav" class="sidenavnr">
        <div class="logo_flex">
            <div class="logo_wrp">
                <a href="<?php echo e(route('dClient')); ?>">
                <img class="logo_m hide" src="<?php echo e(asset('logoo.png')); ?>">
                <img class="logo_m" src="<?php echo e(url('public/logoo.png')); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('logoo.png')); ?>'" />
                        ...
                        <ul class="profile-admin d-flex">
                            ...
                            <li class="nav-item dropdown dropdown-notification me-25">
                                <div class="notifction_text">
                                    <a class="nav-link bella" href="<?php echo e(route('alert')); ?>" data-bs-toggle="dropdown">
                                        <div class="not1">
                            ...
                            <li>
                                <div class="pro-user d-flex">
                                    ...
                                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"><?php echo e(Auth::user()->name); ?></span></div>
                                </div>
                            </li>
                                ...
                                <div class="account-information dropdown-menu">
                                    <div class="account-inner">
                                        ...
                                        <div class="main-heading">
                                            <ul class="list-unstyled" id="nav">
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-one.css')); ?>">
                                                    <div class="color-one"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-two.css')); ?>">
                                                    <div class="color-two"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-three.css')); ?>">
                                                    <div class="color-three"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-four.css')); ?>">
                                                    <div class="color-four"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-five.css')); ?>">
                                                    <div class="color-five"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-six.css')); ?>">
                                                    <div class="color-six"></div>
                                                </a>
                                                </li>
                                                <li>
                                                <a href="#" rel="<?php echo e(url('assets/css/color-seven.css')); ?>">
                                    ...
                                    <div class="account-footer">
                                        <div class="butts">
                                            <ul>
                                                <li>
                                                    <a href="<?php echo e(url('/users/editUserProfile')); ?>" class=""><i class="fa-solid fa-pencil"></i> Edit</a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(url('/logout')); ?>" class=""><i class="fa-solid fa-right-to-bracket"></i> Sign out</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="nav_home">
            <div class="nav navbar-nav">
                <ul class="tmenu-list d">
                    <?php if(in_array("dashboard", $dashboard_access)): ?> 
                    <li class="<?php echo e(request()->segment(1) == 'dClient' ? 'active' : ''); ?>">
                        <a class="btn btn-primary primary_nav " href="<?php echo e(route('dClient')); ?>">
                        Dashboard
                    </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array("dashboard_production", $dashboard_access)): ?> 

                    <li class="<?php echo e(request()->segment(1) == 'production_dashboard' ? 'active' : ''); ?>">
                        <a class="btn btn-primary primary_nav" href="<?php echo e(route('production_dashboard')); ?>">
                        Production Dashboard
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array("dashboard_management", $dashboard_access)): ?> 

                    <li class="<?php echo e(request()->segment(1) == 'fClient' ? 'active' : ''); ?>">
                        <a class="btn btn-primary primary_nav" href="<?php echo e(route('fClient')); ?>">
                        Management Dashboard
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array("dashboard_management", $dashboard_access)): ?> 
                    <li class="<?php echo e(request()->segment(1) == 'mydesk' ? 'active' : ''); ?>">
                        <a class="btn btn-primary primary_nav" href="<?php echo e(route('mydesk')); ?>">
                        My Desk
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(in_array("dashboard_management", $dashboard_access)): ?> 
                    <li class="<?php echo e(request()->segment(1) == 'alert' ? 'active' : ''); ?>">
                        <a class="btn btn-primary primary_nav" href="<?php echo e(route('alert')); ?>">
                        Alert
                        </a>
                    </li>
                    <?php endif; ?>
