...
//            endforeach;
    ...
    public function addProductionReuestDetail(Request $request)
    {
        DB::Connection('mysql2')->beginTransaction();
        try {
            $m = $_GET['m'];
        ...
        return Redirect::to('production/viewProductionRequestList?pageType=' . Input::get('pageType') . '&&parentCode=' . Input::get('parentCode') . '&&m=' . $_GET['m'] );
    }

    
    public function editProductionReuestDetail(Request $request)
    {
        DB::Connection('mysql2')->beginTransaction();
        try {
            $m = $_GET['m'];
    ...
    public function approveAndRejectProductionRequest(Request $request)
    {
        DB::connection('mysql2')->table('production_request')->where('id', $request->id)->update(['approval_status' => $request->approval_status]);
        return;
    }

    public function deleteProductionRequest(Request $request)
    {
