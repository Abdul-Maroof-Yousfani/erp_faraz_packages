...
class FinanceDataCallController extends Controller
{
    ...
    public function getOutstandingpvsDateAndAccontWise(Request $request)
    {
        ...
        if($VoucherStatus != "")
        {
            $pvs=$pvs->where('status',1)->where('pv_status',$VoucherStatus)->whereIn('type',[2,3])->whereBetween('pv_date',array($FromDate,$ToDate))->orderBy('id' , 'desc')->get();
        }
        else
        {
            $pvs=$pvs->where('status',1)->whereIn('type',[2,3])->whereBetween('pv_date',array($FromDate,$ToDate))->orderBy('id' , 'desc')->get();
        }
        endif;
...
<?php
    ...
    function trialBalanceSheet(Request $request)
	{
	    ...
	    $compareYear = Input::get('compareYear');
        $monthArray = Input::get('monthArray');
        ...
        if ($type == 5):
            ...
            elseif ($RadioVal == 2):
                    ...
                    $accounts1 = $accounts1->where('status',1)
                        ->where('code',1)
                        ->orderBy('level1', 'ASC')
                        ->orderBy('level2', 'ASC')
                        ->orderBy('level3', 'ASC')
                    ...
                    $accounts3 = $accounts3->where('status',1)->where('code',3)->where('type','!=',1)
                        ->orderBy('level1', 'ASC')
                        ->orderBy('level2', 'ASC')
                        ->orderBy('level3', 'ASC')
                        ->orderBy('level4', 'ASC')
            ...
            if($request->financial_year_condition == 'true'):
                
                $financial_year = explode(" ",$request->financial_year);
                $from_date = $financial_year[0].'-07-01';
                $to_date = $financial_year[1].'-06-30';

                return view('Finance.AjaxPages.balance_sheet_other_financial',compact('from_date','to_date','financial_year','m','accounts1','accounts2','accounts3'));
            else:
                if($compareYear):
                    // return $this->comparetiveIncomeWithCompare($filterYear , $compareYear , $monthArray);
                    return view('Finance.AjaxPages.balance_sheet_other_comparative_compare',compact('monthArray','compareYear','filterYear','m','accounts1','accounts2','accounts3'));

                else:
                    return view('Finance.AjaxPages.balance_sheet_other_comparative',compact('monthArray','filterYear','m','accounts1','accounts2','accounts3'));
                endif;
            endif;
    ...
    function comparetiveIncomeWithCompare($filterYear , $compareYear , $filterMonth ,$comparetive)
    {
        $CompanyId = Input::get('m');
        return view('Finance.AjaxPages.comparetiveIncomeWithCompareReport',compact('filterYear','compareYear','filterMonth','CompanyId','comparetive'));

    }
    
    function summaryIncome($financial_year,$from_date , $to_date,$comparetive)
    {
        $CompanyId = Input::get('m');
        return view('Finance.AjaxPages.summaryIncomeReport',compact('financial_year','from_date','to_date','CompanyId','comparetive'));
        $filterYear.' - '.$filterMonth;

    }

    function comparetiveIncome($filterYear , $filterMonth,$comparetive)
    {
        $CompanyId = Input::get('m');
        return view('Finance.AjaxPages.comparetiveIncomeReport',compact('filterYear','filterMonth','CompanyId','comparetive'));
        $filterYear.' - '.$filterMonth;
...
<!--                    </div>-->
        ...
        <div class="dropdown">
                <button class="btn btn-primary select_seletion dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"  aria-expanded="false">
                Select
                </button>
                <ul class="dropdown-menu dropdown-menu_multi_select" aria-labelledby="dropdownMenuButton">
                    <li>
                        <a class="dropdown-item">
                            <div class="form-check form_check_2">
                                <input name="category_id" class="checkbox" type="checkbox"  value="7"  id="category_id" />
                    ...
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="sku" class="sku" type="checkbox" value="2" id="sku" checked />
                    ...
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="Rates" class="checkbox" type="checkbox" value="4"  id="Rates" />
                                <label class="form-check-label" for="Brands" >Rates</label>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="value"  class="checkbox" type="checkbox" value="5"  id="value" checked />
                    ...
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="opening_Balance" class="checkbox" type="checkbox"  value="8"   id="opening_Balance" checked />
                                <label class="form-check-label" for="opening_Balance" >opening Balance</label>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="goods_Inwards"    class="checkbox" type="checkbox" value="1"  id="goods_Inwards" checked />
                                <label class="form-check-label" for="goods_Inwards" >goods Inwards</label>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item">
                            <div class="form-check form_check_2">
                                <input name="goods_outwards"  class="checkbox" type="checkbox"  value="6"     id="goods_outwards" checked />
                                <label class="form-check-label" for="goods_outwards" >goods outwards</label>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" >
                            <div class="form-check form_check_2">
                                <input name="profit"  class="checkbox" type="checkbox" value="profit"   id="profit" checked />
                                <label class="form-check-label" for="goods_outwards"  >Profit</label>
                            </div>
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive profit_responsive" style="pading:10px 8px !important;" >
                    ...
                    <div class="head_lines">
                        <div class="text-center head_of_form"><h3 class="text-center">
                            <?php  echo CommonHelper::getCompanyName(Session::get('run_company'));?></h3>
                        </div>

                        <div class="text-center head_of_form">
                            <p class="text-center">Profit & Loss Statement</p>
                        </div>
                        ...
                        <table class="table table-bordered sf-table-th sf-table-list profit_Loss_Statement"style="pading:10px 8px !important;" id="exportIncomeStatement1" style="background:#FFF !important;">
                            ...
                            <tr style="pading:10px 8px !important;">
                                <!--<th>Revenue</th>
                                <th style="" class="text-center">Account</th>
                                <th>Amount</th>-->
                                <th></th>
                            ...
                            <tr>
                                <td <?php if($head==3){ ?> style="font-size: large;font-weight: bolder" <?php } ?> >
                                    <?php if($level == 1):?>
                                        <b style="font-size: large;font-weight: bold"><a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo strtoupper($row->name)?></a></b>
                                    <?php elseif($level == 2):?>
                                        <a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo  ''. $row->name?></a>
                                    <?php elseif($level == 3):?>
                                        <a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo  ''. $row->name?></a>
                                    <?php  elseif($level == 4):?>
                                        <a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo  ''. $row->name?></a>
                            ...
                            ?>
                            <tr>
                                <td style=" font-size: larger;font-weight:bold">Total Revenue</td>
                            ...
                            <td  onclick="showDetailModelOneParamerter('<?= $paramOne ?>','<?= $from_date.','.$to_date.','.'1-2-1-1'?>','Ledger Detail')">Purchases</td>
                             <td title="Net Purchase = Total Debit - Credit Note - Stock Return From Work order - Debit Note - Issuence For Work Order" class="text-right">
                                <?php
                            ...
                            <tr>
                                <td style="font-size: large;font-weight: bolder">Cost Of Goods Sold</td>
                                <?php ; ?>
                            ...
                            <tr data-toggle="Detailed" title="Detailed" data-content="Closing Inventory =Opening +Net Purchas+Sales Return-Sales>
                             <?php echo number_format($open_amount,2).'+'.number_format($purchase_amount,2).'+'.number_format($sales_return,2).'-'.$saless.'='.number_format($open_amount+$purchase_amount+$sales_return-$saless,2) ?>">
                                <td style="font-size: large;font-weight: bolder">Gross Profit</td>
                                <?php
...
<!--                                <td>< ?php echo $row->code.'=='.$level ?></td>-->
                            ...
                            ?>
                            <tr>
                                <td style="font-size: large;font-weight: bolder">Total Expenses</td>
                            ...
                            ?>
                            <tr>
                                <td style="font-size: large;font-weight: bolder">Net Income Before Taxes</td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                            ...
                            <tr>
                                <td style="font-size: large;font-weight: bolder">Income tax expense</td>
                            ...
                            <tr>
                                <td style="font-size: large;font-weight: bolder">Net Income</td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
                                <td class="text-right"><?php echo  $net_income_before ?></td>
	...
	function IncomeStatement(Request $request)
	{
        ...
        if($request->financial_year_condition == 'true'):
            ...
            $from_date = $financial_year[0].'-07-01';
            $to_date = $financial_year[1].'-06-30';
            return $this->summaryIncome($financial_year,$from_date , $to_date,$comparetive);
        else:
            ...
            $monthArray = Input::get('monthArray');
                ...
                if($compareYear):
                    return $this->comparetiveIncomeWithCompare($filterYear , $compareYear , $monthArray,$comparetive);
                else:
                    return $this->comparetiveIncome($filterYear , $monthArray,$comparetive);
                endif;
        endif;
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"></div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="head_lines">
                        ...
                        <div class="text-right head_of_form print_views_para">
                            <p>Printed On: <?php echo date_format(date_create(date('Y-m-d')),'F d, Y')?></p>
                        </div>
                    </div>
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                <table class="table table-bordered sf-table-th sf-table-list profit_Loss_Statement"style="pading:10px 8px !important;" id="exportIncomeStatement1" style="background:#FFF !important;">
                            ...
                            <tr>
                                ...
                                <td <?php if($head==3){ ?> style="font-size: large;font-weight: bolder" <?php } ?> >
                                <?php if($level == 1):?>
                                        <b style="font-size: large;font-weight: bold color:#000" ><a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo strtoupper($row->name)?></a></b>
                                    <?php elseif($level == 2):?>
                                        <a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo  ''. $row->name?></a>
                                    <?php elseif($level == 3):?>
                                        <a href="#" onclick="newTabOpen('<?php echo $from_date?>','<?php echo $to_date?>','<?php echo $row->code?>')"><?php echo  ''. $row->name?></a>
...
//            $this->db->update('transactions',$data);
    ...
    function get_rights(Request $request)
    {
        ...
        $userData = DB::table('users')->where('emp_code',$user_id)->first();
        $crud_rights = explode(',',$userData->crud_rights);

        $category = db::Connection("mysql2")->table('category')->where('status' , 1)->get();

        $m=$_GET['m'];
        return view('Finance.rights',compact('user_id','cost_center','crud_rights','m','MainModuelCode','company_id','userData','category'));
    }
