...
$(window).on('load', function () {
  ...
  var $gainedChartt = document.querySelector('#gained-chartt');
  var $orderChartt = document.querySelector('#order-chartt');
  ...
  var gainedCharttOptions;
  var orderCharttOptions;
  ...
  gainedChartt = new ApexCharts($gainedChartt, gainedCharttOptions);
  gainedChartt.render();
  ...
  orderChartt = new ApexCharts($orderChartt, orderCharttOptions);
  orderChartt.render();
